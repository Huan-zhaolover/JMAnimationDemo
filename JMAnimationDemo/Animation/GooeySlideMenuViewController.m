...
- (void)loadView {
    [super loadView];
    _menu = [[GooeySlideMenu alloc] initWithTitle:@[@"首页", @"消息", @"发布", @"发现", @"个人", @"设置",@"关于"] withButtonHeight:44 withMenuColor:[self colorFromRGB:0x99CCCC] withBackBlurStyle:UIBlurEffectStyleLight];
